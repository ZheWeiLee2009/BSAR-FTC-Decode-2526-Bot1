...
import org.firstinspires.ftc.teamcode.pedroPaths.optimalBluePathsGate;

@Autonomous(name = "optimalBlueHighGate", group = ".")
public class optimalBlueHighGate extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException{
        ...
        optimalBluePathsGate paths;
        paths = new optimalBluePathsGate(follower);
